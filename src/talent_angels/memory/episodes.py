...
Not wired into run_turn yet — record_episode takes the same RunLogRecord
already built there, so wiring it in later is one call next to the
existing append_record.
"""
