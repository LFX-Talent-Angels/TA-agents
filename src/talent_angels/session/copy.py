...
COMMANDS_BLOCK = (
    ...
    "- `/standing` — confirm the bound title as your current role\n"
    "- `/goal` — confirm the bound title as your target role\n"
    "- `/reject` — mark the bound title as not you\n"
    "- `/whoami` or `/profile` — show what's saved about you\n"
    "- `/forget` — erase everything saved about you\n"
    "- `/quit` or `/exit` — leave\n"
    "\n"
